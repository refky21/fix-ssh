...
# Download Node
wget -q -O /usr/local/bin/ws.js "https://raw.githubusercontent.com/refky21/fix-ssh/main/ws.js"
chmod +x /usr/local/bin/ws.js 

# Download New Service
wget -q -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/refky21/fix-ssh/main/ws-js.service"
systemctl enable ws
